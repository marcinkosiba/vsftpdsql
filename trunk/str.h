...
C_COMPATIBLE_FUNCTION void str_alloc_text(struct mystr* p_str, const char* p_src);
...
C_COMPATIBLE_FUNCTION const char* str_strdup(const struct mystr* p_str);
...
C_COMPATIBLE_FUNCTION const char* str_getbuf(const struct mystr* p_str);
