...
parseconf_uint_array[] =
{
  ...
  { "pgsql_database_port", &tunable_pgsql_database_port},  
  { 0, 0 }
};
...
parseconf_str_array[] =
{
  ...
  { "pgsql_database_password", &tunable_pgsql_database_password},
  { "pgsql_database_host", &tunable_pgsql_database_host},  
  { "pgsql_database_dbname", &tunable_pgsql_database_dbname},
  { 0, 0 }
};
