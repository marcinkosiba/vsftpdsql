...
int tunable_plugin_architecture = 1;
...
const char* tunable_sql_plugin = "GenerateErrorPlugin";

/* DB plugins vars */
const char* tunable_mysql_database_username="scott";
const char* tunable_mysql_database_password="tiger";
const char* tunable_mysql_database_host="localhost";
unsigned int tunable_mysql_database_port=0;		//use built-in value
const char* tunable_mysql_database_socketname=0;	//use built-in value
const char* tunable_mysql_database_dbname="vsftp";
unsigned int tunable_mysql_database_connectionflags=0;	//none

const char* tunable_pgsql_database_username="scott";
const char* tunable_pgsql_database_password="tiger";
const char* tunable_pgsql_database_host="localhost";
unsigned int tunable_pgsql_database_port=0;
const char* tunable_pgsql_database_dbname="vsftp";
